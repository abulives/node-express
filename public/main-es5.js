...
var AddressComponent = /** @class */ (function () {
    function AddressComponent(router, myservice) {
        this.router = router;
    ...
    AddressComponent.prototype.saveAddress = function (user) {
        var _this = this;
        user.user_id = localStorage.getItem("user_id");
        this.myservice.saveAddress(user).subscribe(function (data) {
            if (data) {
            ...
            if (error.error.errmsg) {
                _this.errmsg = error.error.errmsg;
            }
...
var AppComponent = /** @class */ (function () {
    function AppComponent(router, myservice) {
        this.router = router;
        this.myservice = myservice;
    ...
    AppComponent.prototype.getCartCount = function () {
        ...
        if (localStorage.getItem("user_id")) {
            ...
            this.myservice.getCartCount(params).subscribe(function (data) {
                if (data.length > 0) {
                    _this.total = data[0].quantity;
                }
            }, function (error) {
            });
        }
    ...
    AppComponent.prototype.updateCount = function () {
        this.total += 1;
    };
    AppComponent.prototype.reduceCount = function () {
        this.total -= 1;
    };
...
var MycartComponent = /** @class */ (function () {
    function MycartComponent(router, myservice, appcomponent) {
        this.router = router;
        this.myservice = myservice;
    ...
    MycartComponent.prototype.ngOnInit = function () {
        ...
        if (localStorage.getItem("user_id")) {
            ...
            this.myservice.getmyCart(product).subscribe(function (data) {
                _this.carts = data;
                _this.findTotal(data);
            }, function (error) {
                console.error("Error", error);
            });
        }
    ...
    MycartComponent.prototype.findTotal = function (data) {
        var total_price = 0;
    ...
    MycartComponent.prototype.removeCart = function (product) {
        var _this = this;
        var params = {
            _id: product.id
        };
        this.myservice.removeCart(params).subscribe(function (data) {
            _this.ngOnInit();
            _this.appcomponent.reduceCount();
        }, function (error) {
            console.error("Error", error);
        });
    };
    MycartComponent.prototype.updateCart = function (product) {
        var _this = this;
        if (localStorage.getItem("user_id")) {
            ...
            cart.price = price;
            this.myservice.addCart(cart).subscribe(function (data) {
                _this.ngOnInit();
                _this.appcomponent.updateCount();
            }, function (error) {
                console.error("Error", error);
            });
        }
    ...
    MycartComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _myservice_service__WEBPACK_IMPORTED_MODULE_3__["MyserviceService"] },
...
var ProductComponent = /** @class */ (function () {
    function ProductComponent(router, myservice, appcomponent) {
        this.router = router;
        this.myservice = myservice;
        this.appcomponent = appcomponent;
    }
    ...
    ProductComponent.prototype.getProduct = function () {
        var _this = this;
        this.myservice.listProducts().subscribe(function (data) {
            if (data) {
                _this.products = data;
            }
        }, function (error) {
    ...
    ProductComponent.prototype.onAddtoCart = function (product) {
        if (localStorage.getItem("user_id")) {
            product.user_id = localStorage.getItem("user_id");
            this.myservice.addCart(product).subscribe(function (data) {
            }, function (error) {
                console.error("Error", error);
            });
